...
# Form implementation generated from reading ui file 'video486.ui'
#
...
class Ui_GestorDescargas(object):
    def setupUi(self, GestorDescargas):
        ...
        self.pbr_descargas = QtWidgets.QProgressBar(self.verticalLayoutWidget)
        self.pbr_descargas.setProperty("value", 0)
        self.pbr_descargas.setObjectName("pbr_descargas")
        self.lay_ver_principal.addWidget(self.pbr_descargas)
        self.btn_iniciar_descargas = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.btn_iniciar_descargas.setObjectName("btn_iniciar_descargas")
        self.lay_ver_principal.addWidget(self.btn_iniciar_descargas)
    ...
    def retranslateUi(self, GestorDescargas):
        ...
        self.btn_iniciar_descargas.setText(_translate("GestorDescargas", "Iniciar Descarga"))
