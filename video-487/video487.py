...
# Form implementation generated from reading ui file 'video-487.ui'
#
...
class Ui_Visor(object):
    def setupUi(self, Visor):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(0, 10, 398, 131))
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.ley_ver_principal = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.ley_ver_principal.setContentsMargins(10, 0, 10, 0)
        ...
        self.ley_ver_principal.addWidget(self.lcd_numero)
        self.lay_hor_botones = QtWidgets.QHBoxLayout()
        self.lay_hor_botones.setContentsMargins(10, -1, 10, -1)
        ...
        self.ley_ver_principal.addLayout(self.lay_hor_botones)
