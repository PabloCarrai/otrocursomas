...
from video468 import Ui_SeleccionVuelo
...
class AplicacionSeleccionVueloVentana(QMainWindow):
    ...
    def inicializarGui(self):
        ...
        self.ui.rbn_clase_negocio.toggled.connect(self.seleccionar_vuelo)
    ...
    def seleccionar_vuelo(self):
        ...
        if self.ui.rbn_primera_clase.isChecked():
            costo_vuelo = 190
        if self.ui.rbn_clase_negocio.isChecked():
            costo_vuelo = 130
        if self.ui.rbn_clase_economica.isChecked():
            costo_vuelo = 99
        self.ui.lbl_resultado_seleccion.setText(f"Costo del vuelo es ${costo_vuelo}")
