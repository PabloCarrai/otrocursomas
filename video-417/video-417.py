...
class PizzaVentana(QMainWindow):
    ...
    def inicializarGui(self):
        ...
        self.chk_aceituna = QCheckBox("Aceituna ($2)", self)
        self.chk_aceituna.move(30, 140)
        self.chk_aceituna.stateChanged.connect(self.calcular_precio_final)
    ...
    def calcular_precio_final(self):
        ...
        if self.chk_queso.isChecked():
            precio_base += 1
        if self.chk_aceituna.isChecked():
            precio_base += 1
