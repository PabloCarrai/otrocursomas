...
class ListaLenguajesVentana(QMainWindow):
    ...
    def inicializarGui(self):
        self.setWindowTitle("Seleccion Lista Lenguajes de Programacion")
        ...
        self.lst_lenguajes.insertItem(1, "C++")
        self.lst_lenguajes.insertItem(2, "C")
        self.lst_lenguajes.insertItem(3, "Go")
        self.lst_lenguajes.insertItem(4, "PHP")
        self.lst_lenguajes.insertItem(3, "Rust")
    ...
    def mostrar_lenguaje_seleccionado(self):
        ...
        self.lbl_lenguaje_seleccionado.setText(f"Selecciono: {lenguaje.text()}")
