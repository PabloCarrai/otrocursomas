...
# Form implementation generated from reading ui file 'video484.ui'
#
...
class Ui_EditorTexto(object):
    def setupUi(self, EditorTexto):
        ...
        EditorTexto.resize(447, 240)
        EditorTexto.setMinimumSize(QtCore.QSize(447, 240))
        EditorTexto.setMaximumSize(QtCore.QSize(447, 240))
        self.verticalLayoutWidget = QtWidgets.QWidget(EditorTexto)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 431, 221))
        ...
        self.lay_frm_componente = QtWidgets.QFormLayout()
        self.lay_frm_componente.setObjectName("lay_frm_componente")
        ...
        self.lay_frm_componente.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.lbl_seleccion_fuente)
        ...
        self.cbx_fuentes.addItem("")
        self.cbx_fuentes.addItem("")
        self.lay_frm_componente.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.cbx_fuentes)
        self.lbl_editor = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.lbl_editor.setObjectName("lbl_editor")
        self.lay_frm_componente.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.lbl_editor)
        self.txt_editor = QtWidgets.QTextEdit(self.verticalLayoutWidget)
        self.txt_editor.setObjectName("txt_editor")
        self.lay_frm_componente.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.txt_editor)
        self.lay_ver_principal.addLayout(self.lay_frm_componente)
    ...
    def retranslateUi(self, EditorTexto):
        ...
        self.cbx_fuentes.setItemText(4, _translate("EditorTexto", "symbols"))
