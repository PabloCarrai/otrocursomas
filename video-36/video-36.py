...
print("El valor de la variable pi es: %.4f" % pi)
print("El valor de la variable total es: %.2f" % total)

print(
    "Creacion de un numero real (punto flotante) a partir de una cadena de caracteres"
)

precio_computador = float(input("Digite el precio del computador:   "))

print(
    "El tipo de dato de la variable precio_computador es %s" % type(precio_computador)
)
