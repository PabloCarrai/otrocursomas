...
class SelectorTamagnioFuenteVentana(QMainWindow):
    ...
    def inicializarGui(self):
        self.setWindowTitle("Cambio de tamaño fuente")
        ...
        self.sdr_selector_tamagnio_fuente.valueChanged.connect(
            self.cambia_tamagnio_fuente
        )
    ...
    def cambia_tamagnio_fuente(self):
        self.lbl_python.setFont(
            QFont("Arial", self.sdr_selector_tamagnio_fuente.value())
        )
