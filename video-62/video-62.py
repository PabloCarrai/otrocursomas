...
# antes de modificar tiene
print(f"Elementos de la variable numeros: {numeros}")
#   modificacion por uso de indices negativos
numeros[-1] = 12  #   Modificamos el ultimo elemento por indice negativo
# luego de modificar tiene
print(f"Elementos de la variable numeros: {numeros}")
#   Que ocurre cuando queremos acceder a un indice que no existe
#print(numeros[8])  # IndexError: list index out of range
