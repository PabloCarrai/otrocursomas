...
class CalculadoraVentana(QMainWindow):
    ...
    def initUi(self):
        ...
        self.txt_primer_numero.setValidator(QIntValidator())
        ...
        self.txt_segundo_numero.setValidator(QIntValidator())
    ...
    def sumar(self):
        primer_numero = int(self.txt_primer_numero.text())
        segundo_numero = int(self.txt_segundo_numero.text())
