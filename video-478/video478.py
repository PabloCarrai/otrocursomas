...
# Form implementation generated from reading ui file 'video478.ui'
#
...
class Ui_Niveles(object):
    def setupUi(self, Niveles):
        ...
        Niveles.resize(480, 480)
        Niveles.setMinimumSize(QtCore.QSize(480, 480))
        Niveles.setMaximumSize(QtCore.QSize(480, 480))
        self.verticalLayoutWidget = QtWidgets.QWidget(Niveles)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(0, 10, 481, 441))
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.ley_ver_principal = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.ley_ver_principal.setContentsMargins(10, 10, 10, 0)
        self.ley_ver_principal.setObjectName("ley_ver_principal")
        ...
        self.ley_ver_principal.addLayout(self.lay_frm_azucar_presion_arterial)
        ...
        self.ley_ver_principal.addLayout(self.lay_hor_pulso_nivel_colesterol)
        ...
        self.ley_ver_principal.addWidget(self.txt_resultado)
    ...
    def retranslateUi(self, Niveles):
        ...
        self.lbl_nivel_azucar.setText(_translate("Niveles", "Nivel de Azucar"))
        self.lbl_presion_arterial.setText(_translate("Niveles", "Presion Arterial"))
