...
from video478 import Ui_Niveles
...
class AplicacionNiveles(QDialog):
    ...
    def mostrar_nivel_azucar(self, valor):
        self.ui.txt_resultado.setText(f"Nivel de azucar: {valor}")

    def mostrar_presion_arterial(self, valor):
        self.ui.txt_resultado.setText(f"Presion arterial: {valor}")
