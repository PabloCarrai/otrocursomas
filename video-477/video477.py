...
# Form implementation generated from reading ui file 'video477.ui'
#
...
class Ui_PuntoVenta(object):
    def setupUi(self, PuntoVenta):
        ...
        self.lbl_pro_teclado = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.lbl_pro_teclado.setObjectName("lbl_pro_teclado")
        self.lay_hor_teclado.addWidget(self.lbl_pro_teclado)
    ...
    def retranslateUi(self, PuntoVenta):
        ...
        self.lbl_pro_teclado.setText(_translate("PuntoVenta", "Producto Teclado HyperX:"))
